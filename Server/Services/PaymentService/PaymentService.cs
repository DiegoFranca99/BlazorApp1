...
namespace BlazorApp1.Server.Services.PaymentService
{
    public class PaymentService : IPaymentService
    {
        ...
        const string secret = "whsec_d6802b9e9d9e14f2e6682a95ac0c9199a0155158172f4e233ea160dbef74499f";
        ...
        public async Task<Session> CreateCheckoutSession()
        {
            ...
            var options = new SessionCreateOptions
            {
                ...
                LineItems = lineItems,
                Mode = "payment",
                SuccessUrl = "https://localhost:7215/order-success",
                CancelUrl = "https://localhost:7215/cart"
            };
